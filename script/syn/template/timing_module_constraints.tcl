...
# set all input ports
set_input_delay -clock clk  -max $max_input_delay  [get_ports my_port_name]
set_input_delay -clock clk  -min $min_input_delay  [get_ports my_port_name]


#set all output ports
set max_output_delay  [expr $period_clk * 0.5]
set min_output_delay  [expr $period_clk * 0.05]
set_output_delay -clock clk  -max $max_output_delay  [get_ports my_port_name]
set_output_delay -clock clk  -min $min_output_delay  [get_ports my_port_name]
