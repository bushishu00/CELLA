...
set_output_delay -clock clk_inv  -max $max_output_delay  [get_ports mac_en_neg]
set_output_delay -clock clk_inv  -min $min_output_delay  [get_ports mac_en_neg]
set_output_delay -clock clk_inv  -max $max_output_delay  [get_ports data_and]
set_output_delay -clock clk_inv  -min $min_output_delay  [get_ports data_and]
set_output_delay -clock clk_inv  -max $max_output_delay  [get_ports col_mux]
set_output_delay -clock clk_inv  -min $min_output_delay  [get_ports col_mux]
